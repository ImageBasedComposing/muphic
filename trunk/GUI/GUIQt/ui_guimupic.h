...
**
** Created: Thu 20. Oct 12:22:04 2011
...
public:
    ...
    void setupUi(QMainWindow *GuiMupic)
    {
        ...
        widget->setGeometry(QRect(10, 10, 258, 313));
        ...
        graphicsView_Pic = new QGraphicsView(widget);
        ...
        progressBar_Generate = new QProgressBar(widget);
    ...
    void retranslateUi(QMainWindow *GuiMupic)
    {
        ...
        lineEdit_InputPic->setText(QApplication::translate("GuiMupic", "./defaulPic", 0, QApplication::UnicodeUTF8));
