...
void GuiMupic::on_horizontalSlider_2_valueChanged(int position)
{
...
void GuiMupic::on_horizontalSlider_6_valueChanged(int position)
{
...
void GuiMupic::on_horizontalSlider_colorLevels_valueChanged(int position)
{
...
void GuiMupic::on_horizontalSliderTH_valueChanged(int position)
{
...
void GuiMupic::on_horizontalSliderTS_valueChanged(int position)
{
...
void GuiMupic::on_horizontalSliderTV_valueChanged(int position)
{
...
void GuiMupic::on_horizontalSlider_3_valueChanged(int position)
{
    double poslog = 0;
    if (position != 0)
    {
