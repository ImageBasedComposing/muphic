...
\gotrev{Última revisión hecha el 13-06-2012}\\
	...
	\section{¿Qué es Muphic?}
		...
		Teniendo todo eso en cuenta, comentaremos en las siguientes secciones cómo se ha abordado el proceso. En primer lugar hablaremos del estado del arte y las diferentes investigaciones y pruebas realizadas hasta el momento (Sección~\ref{sec:estadodelarte}). Seguidamente, en el Capítulo~\ref{chap:guiauso} se expone la forma de usar la herramienta que se ha desarrollado. Más adelante, en el Capítulo~\ref{chap:diseno}, exponemos de forma detallada los algoritmos usados tanto en el análisis de imagen como en la composición musical. Por último, en el Capítulo~\ref{chap:arquitectura} se explica el sistema en detalle y cómo se ha realizado.
