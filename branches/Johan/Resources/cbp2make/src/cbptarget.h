...
class CBuildTarget
{
 ...
 public:
  ...
  CString AutoFileExtension(const CPlatform::OS_Type OS);
  ...
  CString IncDirs(void);
  CString IncDirs(const CString& ProjectIncDirs);
  CString ResDirs(void);
  CString ResDirs(const CString& ProjectResDirs);
  CString LibDirs(void);
  CString LibDirs(const CString& ProjectLibDirs);
  CString Libs(const CPlatform::OS_Type OS);
