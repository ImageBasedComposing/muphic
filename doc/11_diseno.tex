...
\section{Requisitos}
\todo{Decidir si mandar esta sección a revisión o no}
	...
	\begin{itemize}
		...
		\todo{si no llegamos a establecer una forma fija y sencilla de añadir compositores de forma externa, hay que borrar este usuario}
	\end{itemize}
