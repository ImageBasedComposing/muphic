...
\label{chap:guiauso}
	...
	\gotrev{Última Revisión: 20-06-2012}
		...
		\noindent\textit{Carga de imagen de entrada [G]:} Permite al usuario elegir la dirección desde donde se cargará la imagen de entrada.\\
		
		\noindent\textit{Selección del archivo de audio de salida [H]:} Permite al usuario elegir la dirección donde se guardará el archivo de salida.\\
