...
\subsection{Vista de Implementación}
	...
	\begin{itemize}
		...
		\item \textbf{TinyXML:} Se trata de un paquete externo de código libre que permite generar y manipular archivos XML.\todo{falta introducir tinyxml de forma aceptable en algún lado, o poner referencia aquí a alguna fuente buena}
